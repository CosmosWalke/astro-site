...
// Динамический импорт модального окна (без SSR)
const CommunityModal = dynamic(
  () => import('@/components/CommunityModal').then(mod => mod.CommunityModal),
  { ssr: false }
)
            ...
            <div className="location active" id="loc-1">
              <div className="panorama-wrapper">
                ...
                <div className="layer-interactive">
                  <div className="hotspot" data-percent-x="10.77" data-percent-y="51.80" data-label="COMMUNITY" onClick={() => { window.location.href = '/community'; }}>
                    <div className="hotspot-dot"></div>
                  </div>
                  
                  <div className="hotspot" data-percent-x="50.09" data-percent-y="43.09" data-label="ABOUT" onClick={() => { window.location.href = '/about'; }}>
                    <div className="hotspot-dot"></div>
