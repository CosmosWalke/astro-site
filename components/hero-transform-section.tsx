            ...
            <div ref={panoramaInnerRef} className="absolute top-0 left-0 w-full" style={{ height: 'auto' }}>
              ...
              <div 
                ...
                style={{ 
                  ...
                  transform: `scale(${isMobile ? (isLowEnd ? 1.40 : 1.55) : 1.25}) translateY(0px)`,  
                  transformOrigin: 'center top' 
                }}
              >
                <img
              ...
              <div 
                ...
                style={{ 
                  marginTop: isMobile ? '-4.55vh' : '-45vh',
                  transform: `scale(${isMobile ? (isLowEnd ? 1.32 : 1.47) : 1.25}) translateY(0px)`, 
                  transformOrigin: 'center top' 
                }}
              >
                <img
              ...
              <div 
                ...
                style={{ 
                  marginTop: isMobile ? '-4.55vh' : '-45vh',
                  transform: `scale(${isMobile ? (isLowEnd ? 1.34 : 1.49) : 1.25}) translateY(0px)`, 
                  transformOrigin: 'center top' 
                }}
              >
                <img
              ...
              <div 
                ...
                style={{ 
                  marginTop: isMobile ? '-4.55vh' : '-45vh',
                  transform: `scale(${isMobile ? (isLowEnd ? 1.36 : 1.51) : 1.25}) translateY(0px)`, 
                  transformOrigin: 'center top' 
                }}
              >
                <img
